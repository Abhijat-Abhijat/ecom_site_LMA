...
const Product = () => {
  ...
  return (
    <div>
      ...
      <div className="flex mt-[20px] h-[100vh] p-[10px] mb-[380px] md:mb-[200px] lg:mb-[100px] md:p-[50px] flex-col md:flex-row">
        <div className=" flex-1 block md:hidden">
          <img
            src={product.img1}
            className="w-full h-[40vh] md:h-[90vh] object-cover  z-[1]"
          />
        </div>
        ...
        <div className="flex-[1] p-3 md:px-[50px] md:py-0 md:w-[70%]">
